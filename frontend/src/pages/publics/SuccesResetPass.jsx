...
export default function SuccesResetPass() {
    return(
        <section id="succesResetPassword" className="font-Open Sans min-h-screen flex items-center justify-center relative overflow-hidden px-4 sm:px-6 lg:px-8 py-14">
            <img 
            ...
            <div className="w-full relative max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl rounded-3xl sm:rounded-4xl p-6 sm:p-8 md:p-10 border-2 border-black bg-white items-center flex flex-col gap-10 z-10">
                ...
                <div className="flex flex-col gap-5 items-center">
                    <h1 className="text-3xl sm:text-4xl text-heading font-bold">Successful Password Reset</h1>
                    <p className="text-xl text-gray-500 text-center">You can now use your new password to log back into your account!</p>
                </div>
                <div className="flex flex-col gap-5 sm:gap-8 items-center w-full">
                    <NavLink
                        to="/login"
